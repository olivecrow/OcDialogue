...
{
    [Serializable]
    public class DataRowContainerV2
    {
        public AddressableData Parent;
        [TableList(IsReadOnly = true)]public List<DataRowV2> DataRows;
        ...
        public DataRowV2 AddData()
        {
            AssetDatabase.SaveAssets();
            var row = ScriptableObject.CreateInstance<DataRowV2>();
