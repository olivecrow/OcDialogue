    ...
    public class DialogueUI : MonoBehaviour
    {
        ...
        IEnumerator Process()
        {
            ...
            while (true)
            {
                ...
                var linkedBalloons = children.Where(x => x.type == Balloon.Type.Dialogue).ToList();
        ...
        IEnumerator PrintContents()
        {
            ...
            var actorName = Balloon.actor == null || Balloon.actor.NPCName == "System" ? "" : Balloon.actor.NPCName;
