...
{
    [Serializable]
    public class DataCheckerV2
    {
        public CheckFactorV2[] factors;
        ...
        public static List<CheckGroup> CreateCheckGroups(List<CheckFactorV2> factors, List<Binding> bindings)
        {
