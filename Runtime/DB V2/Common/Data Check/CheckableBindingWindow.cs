...
namespace OcDialogue.DB
{
    ...
    {
        public DataCheckerV2 Checker { get; private set; }
        ...
        public void SetChecker(DataCheckerV2 checker)
        {
            Checker = checker;
        ...
        void PreviewExpression()
        {
            ...
            var tmpGroups = DataCheckerV2.CreateCheckGroups(Checker.factors.ToList(), allBindings);
        ...
        ValueDropdownList<int> GetIndexDropDown()
        {
            ...
            var tmpGroups = DataCheckerV2.CreateCheckGroups(Checker.factors.ToList(), tempBindings);
